            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BuyerId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipingAddress_FullName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipingAddress_Address1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipingAddress_Address2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipingAddress_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipingAddress_State = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipingAddress_ZipCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
